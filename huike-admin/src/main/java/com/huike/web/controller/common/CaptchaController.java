...
public class CaptchaController {
    ...
    public CaptchaImageAjaxResult getCode(HttpServletResponse response) throws IOException
    {
        ...
        {
            return CaptchaImageAjaxResult.error(e.getMessage());
        }

        CaptchaImageAjaxResult ajax = CaptchaImageAjaxResult.success();
        //ajax.put("uuid", uuid);
        ajax.setUuid(uuid);
        //ajax.put("img", Base64.encode(os.toByteArray()));
        ajax.setImg(Base64.encode(os.toByteArray()));
        System.out.println("captchaImage...end");
        return ajax;
    }
}
